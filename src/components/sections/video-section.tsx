...
const videos: VideoData[] = [
  ...
  {
    id: 'video2',
    title: 'How to build an AI Business Platform | For any Startup 2025',
  ...
  },
  {
    id: 'video4',
    title:
      'Why your AI Business is broken and How to fix it: RAG | Step-by-step ( Real Estate client )',
  ...
  },
  {
    id: 'video5',
    title:
      'How to add Knowledge bases in VAPI with TRIEVE | Tutorial in 6 minutes',
    embedUrl: 'https://www.youtube.com/embed/chGi_7LuvNk?si=nxkL3wRzKuxFaPQo',
    thumbnailUrl: 'https://img.youtube.com/vi/VIDEO_ID/maxresdefault.jpg',
  },
  {
    id: 'video5',
    title: '80K/mo AI Business Platform for Real Estate [Full-Explained]',
